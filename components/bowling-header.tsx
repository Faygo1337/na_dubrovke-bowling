        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <Link href="/bowling#menu" className="text-white hover:text-orange-400 transition-colors">
                Меню
              </Link>
              <Link href="/bowling#prices" className="text-white hover:text-orange-400 transition-colors">
                Цены
              </Link>
              <Link href="/bowling#gallery" className="text-white hover:text-orange-400 transition-colors">
                Интерьер
              </Link>
              <Link href="/bowling/events" className="text-white hover:text-orange-400 transition-colors">
                События
              </Link>
              <Link href="/club" className="bg-purple-600 hover:bg-purple-700 px-4 py-2 rounded-lg transition-colors">
                Клуб
              </Link>
            </nav>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <Button onClick={() => setIsBookingOpen(true)} className="bg-orange-500 hover:bg-orange-600">
                Забронировать
              </Button>
            </div>
