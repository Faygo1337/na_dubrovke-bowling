...
import { ArrowRight, Trophy, Phone, Utensils, Wine, Users, Star, Clock, MapPin, ExternalLink } from "lucide-react"
...
export default function BowlingHomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-[80vh] bg-gradient-to-r from-slate-900 via-slate-800 to-orange-900 flex items-center">
        ...
        <div className="container mx-auto pt-16 px-4 relative z-10">
          <div className="max-w-3xl text-white">
            <Badge className="bg-orange-500 text-white mb-4">Лучший боулинг в Могилеве</Badge>
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Na Dubrovke
              <span className="block text-orange-400">Bowling Club</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-200">
              Современный боулинг-клуб с 8 профессиональными дорожками, рестораном и баром. Идеальное место для отдыха с
              друзьями и семьей.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-4">
                ...
                <p className="text-gray-600">Современные профессиональные дорожки Brunswick</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-4">
                ...
                <p className="text-gray-600">Вкусная европейская и белорусская кухня</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-4">
                ...
                <p className="text-gray-600">Широкий выбор напитков и коктейлей</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-4">
                ...
                <p className="text-gray-600">Турниры, корпоративы и дни рождения</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold mb-6">Добро пожаловать в Na Dubrovke</h2>
              <p className="text-lg text-gray-600 mb-6">
                Наш боулинг-клуб расположен в самом сердце Могилева на улице проспект Мира, 21А. Мы предлагаем профессиональное оборудование Brunswick и незабываемую атмосферу для игры в боулинг.
              </p>
      ...
      <section id="menu" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold mb-4">Ресторан и Бар Na Dubrovke</h2>
            <p className="text-xl text-gray-600">Вкусная еда и напитки прямо к вашей дорожке</p>
          </div>
      ...
      <section id="prices" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Доступные цены для всей семьи</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-2 border-gray-200 hover:border-orange-500 transition-colors">
              <CardContent className="p-8 text-center">
                ...
                <div className="text-sm text-gray-600 mb-2">Понедельник - Четверг</div>
                <div className="text-4xl font-bold text-orange-500 mb-4">25 BYN</div>
                <p className="text-gray-600 mb-4">за дорожку в час</p>
                <div className="space-y-2 text-sm">
                  <div>12:00 - 18:00</div>
                  <div className="text-orange-500 font-semibold">20 BYN после 18:00</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-orange-500 relative">
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="text-4xl font-bold text-orange-500 mb-4">35 BYN</div>
                <p className="text-gray-600 mb-4">за дорожку в час</p>
                <div className="space-y-2 text-sm">
                  <div>12:00 - 18:00</div>
                  <div className="text-orange-500 font-semibold">40 BYN после 18:00</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-gray-200 hover:border-orange-500 transition-colors">
              <CardContent className="p-8 text-center">
                ...
                <div className="text-sm text-gray-600 mb-2">Суббота - Воскресенье</div>
                <div className="text-4xl font-bold text-orange-500 mb-4">40 BYN</div>
                <p className="text-gray-600 mb-4">за дорожку в час</p>
                <div className="space-y-2 text-sm">
                  <div>Весь день</div>
      ...
      <section id="gallery" className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Современные дорожки и уютная атмосфера</p>
          </div>
              ...
              <div key={i} className="relative group overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="text-white text-center">
                    ...
                    <p className="text-sm">Профессиональное оборудование Brunswick</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-orange-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Забронируйте дорожку прямо сейчас и получите незабываемые впечатления от игры в боулинг!
          </p>
      ...
      <div style={{position: 'relative', overflow: 'hidden'}}>
        <a href="https://yandex.by/maps/158/mogilev/?utm_medium=mapframe&utm_source=maps" style={{color: '#eee', fontSize: '12px', position: 'absolute', top: '0px'}}>Могилёв</a>
        <a href="https://yandex.by/maps/158/mogilev/house/Z0kYdQVnSUEEQFtpfXVxeHpkbA==/?ll=30.327043%2C53.909678&utm_medium=mapframe&utm_source=maps&z=17.28" style={{color: '#eee', fontSize: '12px', position: 'absolute', top: '14px'}}>Проспект Мира, 21А — Яндекс Карты</a>
        <iframe src="https://yandex.by/map-widget/v1/?ll=30.327043%2C53.909678&mode=search&ol=geo&ouri=ymapsbm1%3A%2F%2Fgeo%3Fdata%3DCgoxNTkyNjIwOTMyEkHQkdC10LvQsNGA0YPRgdGMLCDQnNCw0LPRltC70ZHRniwg0L_RgNCw0YHQv9C10LrRgiDQnNGW0YDRgywgMjHQkCIKDced8kEVg6NXQg%2C%2C&z=17.28" width="100%" height="400" frameBorder="0" allowFullScreen={true} style={{position: 'relative'}}></iframe>
      </div>
